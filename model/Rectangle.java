...
/*
 * Description: 
 * A concrete Rectangle Shape Object created by a Strategy Pattern object (IShapeStrategy) via
...
public class Rectangle implements IShapeStrategy{
	Pair start;
	Pair end;
	Color primaryC;
    Color secondaryC;
	...
	public Rectangle(Pair start, Pair end, Color primaryC, Color secondaryC, ShapeShadingType shadingType, Graphics2D graphics2d) {
		this.start = start;
		this.end = end;
